...
function WorkoutPlansIconSVG({ fill }): ReactElement {
  return (
    <svg width='50' height='50' viewBox='-5 -5 110 110' xmlns='http://www.w3.org/2000/svg' fill='white'>
      <path
...
export default WorkoutPlansIconSVG;
