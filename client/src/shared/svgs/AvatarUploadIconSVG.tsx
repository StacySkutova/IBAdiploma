...
function AvatarUploadIconSVG(): ReactElement {
  return (<svg xmlns='http://www.w3.org/2000/svg' width='50' height='50' viewBox='0 0 20 300'>
      <path
...
export default AvatarUploadIconSVG;
