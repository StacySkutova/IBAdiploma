...
export default function ModalUpdateUserProfile({
  modalActive,
  setModalActive,
  setData,
  usersList,
  ...
  const isSignUpSuccess = useSelector(selectIsUserDataSuccess);
          ...
          {isSignUpSuccess && (
            <div className={styles.SignUpForm__infoBlock}>
              ...
              <button
                type="button"
                onClick={() => {
                  dispatch(setIsUserDataSuccess(false));
